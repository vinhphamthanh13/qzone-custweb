...
const rootRoutes = [
  ...
  },
  {
    exact: true,
    strict: true,
    path: '/organization/:orgRef/provider-by-service/:sId',
  ...
  },
  {
    exact: true,
    strict: true,
    path: '/organization/:orgRef/booking/confirmation',
  ...
  },
  {
    exact: true,
    strict: true,
    path: '/organization/:orgRef/survey/:surveyId/:customerId',
    name: 'Take survey',
  ...
  },
  {
    exact: true,
    strict: true,
    path: '/organization/:orgRef/booking/instant/:id',
  ...
  },
  {
    exact: true,
    strict: true,
    path: '/organization/:orgRef/booking/waitlist/:id',
