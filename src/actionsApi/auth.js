...
export const storeAwsUser = (body, token) => axios.put('/aws-users', body, createHeaders(token));
export const updateSocialUsers = (body, token) => axios.put('/users', body, createHeaders(token));
